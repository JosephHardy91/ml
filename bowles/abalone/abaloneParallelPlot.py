...
minRings=float(abalone['Rings'].min())
maxRings=float(abalone['Rings'].max())
...
#renormalize using mean and standard variation, then compress with logit function
meanRings=abalone['Rings'].mean()
sdRings=abalone['Rings'].std()
